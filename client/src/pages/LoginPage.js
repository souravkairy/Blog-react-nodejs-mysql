...
const LoginPage = () => {
    ...
    return (
        <div className="mx-5 my-5 sm:rounded-lg ">
            <div className="max-w-md mx-auto bg-gray-300 p-6">
                <div className="">
                    <div className='mb-6'>
                        <h3 className="text-4xl leading-6 font-medium text-gray-900">Login</h3>
                    </div>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-center">
                                <button
                                    type="submit"
                                    className="w-full py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-sm text-white bg-indigo-600 hover:bg-indigo-700 "
                                >
                                    login
                                </button>
                            </div>
